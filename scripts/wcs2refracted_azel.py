...
class wcs2refracted_azel(object):
    ...
    def __init__(self):
        rospy.Subscriber('/necst/telescope/coordinate/wcs_azel_cmd',Float64MultiArray,self.recieve_wcs)
    ...
    def convert_azel(self,dt):
        on_coord = SkyCoord(self.wcs[0], self.wcs[1],frame=self.wcs_frame, unit=(u.deg, u.deg))
