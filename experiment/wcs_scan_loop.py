...
for i in range(num):
    ...
    antenna.move_raster_wcs_azel(x,y,lx=lx,ly=0 ,scan_t=scan_t, frame=on_frame, l_unit="deg")
    ...
    antenna.move_raster_wcs_azel(x,y,lx=0 ,ly=ly,scan_t=scan_t, frame=on_frame, l_unit="deg")
